...
// ===== Middleware =====
app.use(cors({
  // It's good practice to restrict the origin in production
...
  queueLimit: 0,
  ssl: {
    // Use this if your database requires SSL, otherwise it can be removed.
...
  params: {
    folder: 'modelconnect', // A folder name in your Cloudinary account
...
        // CORRECTED: Get the permanent URL from Cloudinary via req.files[...][0].path
...
            // CORRECTED: Map gallery files to their permanent Cloudinary URLs
...
        
        // CORRECTED: Map files to their permanent Cloudinary URLs
