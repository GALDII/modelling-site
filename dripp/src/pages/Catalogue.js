                ...
                if (activeTab === 'editors') {
                    return (
                        <motion.div key={item.id} className="bg-white rounded-xl shadow-lg overflow-hidden border">
                            <div className="relative aspect-video bg-black"><video src={`http://localhost:5000/uploads/${item.video_url}`} controls className="w-full h-full object-cover"></video></div>
                            <div className="p-5">
                    ...
                    return (
                         <motion.div key={item.id} className="bg-white rounded-xl shadow-lg group transform hover:-translate-y-2 transition-all duration-300 ease-in-out hover:shadow-2xl border border-transparent hover:border-pink-200">
                            <div className="relative overflow-hidden rounded-t-xl">
                                <img src={`http://localhost:5000/uploads/${item.image}`} alt={item.name} className="w-full h-80 object-cover transition-all duration-500 group-hover:scale-110" />
